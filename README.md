...
<p> Easy deployment of a fully featured Kubernetes on your machine with Vagrant </p>
...
After having to go through the process of creating Kubernetes clusters multiple times on my machine, I wanted to make the process as automated, streamlined and effortless as possible. While there are many Vagrant resources out there,
...
- [**Install VirtualBox**](https://www.virtualbox.org/wiki/Downloads) - and add "Host-Only" Network Interface with ip 192.168.10.1
