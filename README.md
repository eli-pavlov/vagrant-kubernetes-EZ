...
Vagrant doesn't just deploy the Kubernetes cluster - it provides, configures and manages the lifecycle of all the underlaying infrastructure and Virtual Machines.
