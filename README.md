...
After having to go through the process of creating Kubernetes clusters multiple times on my machine, I wanted to make </br> the process as repeatable, streamlined and effortless as possible. While there are many Vagrant boxes and repos out there, 
